...
if( (!empty($nazwa)) && (!empty($opis)) && (is_uploaded_file($image_tmp)) && $kategoria!="default" && $wiek!="default" && (!empty($telefon)) && (!empty($wojewodztwo)))

   {
   	...
   	$update = $db->query("UPDATE `wizytowki` SET nazwa = :nazwa, strona = :strona, wojewodztwo = :wojewodztwo, powiat = :powiat, gmina = :gmina, miasto = :miasto, ulica = :ulica, kodpocztowy = :kodpocztowy, telefon = :telefon, opis = :opis, kategoria = :kategoria, wiek = :wiek, zdjecie = :zdjecie, zdjecie2 = :zdjecie2, zdjecie3 = :zdjecie3, zdjecie4 = :zdjecie4, zdjecie5 = :zdjecie5, info_title1 = :info_title_1, info_text1 = :info_text_1, info_title2 = :info_title_2, info_text2 = :info_text_2, info_title3 = :info_title_3, info_text3 = :info_text_3, info_title4 = :info_title_4, info_text4 = :info_text_4 WHERE id=:id",
				array("nazwa"=>$nazwa,"strona"=> $strona,"wojewodztwo"=>$wojewodztwo,"powiat"=>$powiat,"gmina"=>$gmina,"miasto"=>$miasto,"ulica"=>$ulica,"kodpocztowy"=>$kodpocztowy,"telefon"=>$telefon,"opis"=>$opis,"kategoria"=>$kategoria,"wiek"=>$wiek,"zdjecie"=>$image_nazwa,"zdjecie2"=>$image2_nazwa,"zdjecie3"=>$image3_nazwa,"zdjecie4"=>$image4_nazwa,"zdjecie5"=>$image5_nazwa,"info_title_1"=>$tytul_1,"info_text_1"=>$opis_1,"info_title_2"=>$tytul_2,"info_text_2"=>$opis_2,"info_title_3"=>$tytul_3,"info_text_3"=>$opis_3,"info_title_4"=>$tytul_4,"info_text_4"=>$opis_4,"id"=>$id ));
